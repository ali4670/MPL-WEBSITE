        ...
        <div className="relative z-10 flex flex-col justify-center px-16 xl:px-20">
          ...
          >
            <div className="w-14 h-14 rounded-2xl bg-primary flex items-center justify-center mb-6 shadow-lg shadow-primary/20">
              <span className="text-background text-xl font-black italic tracking-tighter">MPL</span>
            </div>
            <h1 className="text-4xl xl:text-5xl font-black italic tracking-tighter text-foreground leading-none mb-3">
              MISR<span className="text-primary">-</span>LIBRARY
            </h1>
            <p className="text-muted-foreground text-sm max-w-sm leading-relaxed">
              {isAr
                ? "مكتبة مصر العامة بدمنهور - بوابتك للمعرفة والثقافة والمجتمع"
                : "Misr Public Library Damanhour - Your gateway to knowledge, culture, and community."}
            </p>
          </motion.div>
          ...
          >
            {[
              { value: "12K", label: isAr ? "متر مربع" : "SQ.METERS" },
              { value: "2009", label: isAr ? "سنة التأسيس" : "EST." },
              { value: "14+", label: isAr ? "活动" : "PROGRAMS" },
            ].map((stat, i) => (
        ...
        >
          ...
          <div className="lg:hidden flex items-center gap-3 mb-10">
            <div className="w-10 h-10 rounded-xl bg-primary flex items-center justify-center shadow-lg shadow-primary/20">
              <span className="text-background text-sm font-black italic tracking-tighter">MPL</span>
            </div>
            <span className="text-foreground font-black italic tracking-tight text-lg">MISR LIBRARY</span>
          </div>
