...
export function SpotlightCard({ spotlight }: { spotlight: any }) {
  const username = spotlight?.profiles?.username || "library.damanhour";
  const avatarUrl =
    spotlight?.avatar_override_url ||
    "https://images.unsplash.com/photo-1507842217343-583bb7270b66?auto=format&fit=crop&q=80&w=200&h=200";
  const title = spotlight?.title || "Misr Public Library";
