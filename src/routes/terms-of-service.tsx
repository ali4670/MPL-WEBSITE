...
function TermsOfService() {
  ...
  const sections = isAr ? [
    {
      title: "1. قبول الشروط",
      content: "باستخدامك لمنصة MPL Damanhour، فإنك توافق على هذه الشروط والأحكام. إذا كنت لا توافق على أي جزء من هذه الشروط، يرجى عدم استخدام المنصة. نحتفظ بحق تعديل هذه الشروط في أي وقت دون إشعار مسبق."
    },
    {
  ...
  ] : [
    {
      ...
      content: "By using the MPL Damanhour platform, you agree to these Terms and Conditions. If you do not agree to any part of these terms, please do not use the platform. We reserve the right to modify these terms at any time without prior notice."
    },
    {
