...
function PrivacyPolicy() {
  ...
  const sections = isAr ? [
    { title: "1. مقدمة", content: "نحن في MPL Damanhour نحترم خصوصيتك ونلتزم بحماية بياناتك الشخصية. توضح سياسة الخصوصية هذه كيف نجمع معلوماتك واستخدامها ونحميها عند استخدامك لمنصتنا التعليمية." },
    ...
    { title: "1. Introduction", content: "At MPL Damanhour, we respect your privacy and are committed to protecting your personal data. This Privacy Policy explains how we collect, use, and protect your information when you use our educational platform." },
